...
const Food = () => {
	...
	// 			"Authorization":"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NTM5ODgxN2RlYjdmZDJjODE4MTgxZjkiLCJpYXQiOjE2OTkxMTY1MDMsImV4cCI6MTY5OTM3NTcwM30.vMObIJSVEUb6JrZN4Z0lcy4TkembvrC0Yzf7VdODgbA"
	// 		},
    //         body: JSON.stringify({
    //             "name": "Chick-fil-a"
    //           })
                        ...
                        <tbody>
                            {cfa.map((item) => (
                                <tr>
                                    ...
                                    <td class="protein">{item.Protein}g</td>
                                    <td class="carbs">{item.Carbs}g</td>
                                    <td class="fats">{item.Fat}g</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
